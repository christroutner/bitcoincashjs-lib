...
TransactionBuilder.fromTransaction = function(
  transaction,
  network,
  bitcoinCashTx
) {
...
TransactionBuilder.prototype.sign = function(
  ...
  try {
    ...
    var signatureHash = this.tx.hashForCashSignature(
      vin,
      input.signScript,
      witnessValue,
      hashType
    ...
    var signed = input.pubKeys.some(function(pubKey, i) {
      ...
      input.signatures[i] = signature.toScriptSignature(
        hashType,
        signatureAlgorithm
      );
      return true;
    ...
    console.error(`Error in bitcoincashjs-lib/transaction_builder.js/sign()`);
    throw err;
  }
};
