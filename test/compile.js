...
describe('#compile', () => {
  it('should correctly compile OP_RETURN SLP SEND transaction', () => {
    const scriptArr = [
      ...
      Buffer.from("01", "hex"),
      Buffer.from(`SEND`),
      Buffer.from("73db55368981e4878440637e448d4abe7f661be5c3efdcbcb63bd86a01a76b5a", "hex"),
    ...
    const correctStr = "6a04534c500001010453454e442073db55368981e4878440637e448d4abe7f661be5c3efdcbcb63bd86a01a76b5a0400000001"
